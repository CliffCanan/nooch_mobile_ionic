angular.module('noochApp.transferDetails-service', ['noochApp.services'])
  .service('transferDetailsService', function ($http, $localStorage) {
      ...
      this.CancelMoneyRequestForExistingNoochUser = function (transactionId) {
          return $http.get(URLs.CancelMoneyRequestForExistingNoochUser + '?TransactionId=' + transactionId + '&MemberId=' + $localStorage.GLOBAL_VARIABLES.MemberId);
      };

      this.CancelMoneyRequestForNonNoochUser = function (transactionId) {
          return $http.get(URLs.CancelMoneyRequestForNonNoochUser + '?TransactionId=' + transactionId + '&MemberId=' + $localStorage.GLOBAL_VARIABLES.MemberId);
      };
